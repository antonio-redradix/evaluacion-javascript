...
function main() {
  ...
  document.body.onkeydown = function (event) {
    if (event.keyCode == 38) {
      ...
      if (contador < 7) {
        var aumento = parseInt(window.getComputedStyle(document.getElementById("ballon")).fontSize);
        aumento = aumento + 50;
      ...
      var decremento = parseInt(window.getComputedStyle(document.getElementById("ballon")).fontSize);
  ...
  document.getElementById("ballon").onclick = function (event) {
    document.getElementById("ballon").innerText = "💥";
    contador = Infinity;
  };
}
