...
/*#__PURE__*/
function () {
  function Globo(ballon) {
    _classCallCheck(this, Globo);
  ...
  */
  ...
  _createClass(Globo, [{
    ...
    value: function init(newBallon) {
      ...
      document.getElementById("ballon").addEventListener("click", function () {
        return _this.explosion(event);
      });
    }
  }, {
    key: "increaseSize",
    value: function increaseSize() {
      if (this.increaseNum < 7 && this.ballonStatus) {
        ...
        var _ballonHtml = document.getElementById("ballon");

        _ballonHtml.innerHTML = "💥";
      }
    }
  }, {
    key: "decreaseSize",
    ...
    key: "explosion",
    value: function explosion(event) {
      this.ballonStatus = false;
      var ballonHtml = document.getElementById("ballon");
